                        ...
                        <div className="all">
                            <ul>
                                ...
                                <li>
                                    ...
                                    1. Donations Accepted in Quantity of plates<br />
                                    2. Donations Accepted in Quantity of Kilograms for Prepared food but in Bulk<br />
                                    3. Donations Accepted in Quantity of Kilograms for Raw Groceries like Rice, Wheat, Grams, etc,.<br />
                                    4. Donations Accepted in Quantity of Packets for classification of Processed Items such as Packets of Biscuits, Munchies etc,.
                                </li>
                            </ul>
                        </div>
                    </section>
                </div>
                <div style={{ marginTop: isMobile ? "" : "113em", }}>
                    <DonationRequestForm />
                </div>
            </section>
            <Footer />
