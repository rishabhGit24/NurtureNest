  ...
  const medicalCategories = [
    {
      ...
      description: "Bandages, antiseptics, and basic medical kits",
      icon: HeartIcon,
    ...
    },
    {
      ...
      description: "Vitamins, health supplements, and wellness products",
      icon: HeartIcon,
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <motion.div
            ...
            className="mx-auto w-24 h-24 bg-gradient-to-br from-red-500 to-pink-500 rounded-3xl flex items-center justify-center mb-6"
          >
          ...
          >
            Support children's health by donating medical supplies, first aid kits, and health monitoring equipment. Every donation helps ensure their well-being.
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Choose from various medical donation categories to support children's health
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {medicalCategories.map((category, index) => (
              ...
              >
                <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 lg:p-8 border border-gray-100 group-hover:border-red-200">
                  ...
                  <h3 className="text-xl lg:text-2xl font-bold text-gray-900 mb-3 group-hover:text-red-600 transition-colors duration-300">
                    {category.title}
                  </h3>
          ...
          >
            <div className="text-center mb-6">
              <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-2">
                Find Orphanages for Medical Donations
              </h2>
              <p className="text-gray-600">
                Search for orphanages in your area that need medical supplies
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button
                ...
                className="bg-gradient-to-r from-red-600 to-pink-600 text-white font-medium py-3 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
              >
                Search
              </button>
            </div>
            ...
            <div className="p-6 lg:p-8 border-b border-gray-200">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                  ...
                  <p className="text-gray-600">
                    Discover orphanages and get directions to make your medical donations
                  </p>
                </div>
                <button
                  ref={relocateBtnRef}
