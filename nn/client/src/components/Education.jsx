  ...
  const educationCategories = [
    {
      ...
      description: "Books, notebooks, pens, and stationery",
      icon: AcademicCapIcon,
      color: "from-[#53AEC6] to-[#007290]",
    },
    {
      title: "Educational Toys",
      description: "Learning games and puzzles",
      icon: AcademicCapIcon,
      color: "from-green-500 to-emerald-500",
    },
    {
      title: "Technology",
      description: "Computers, tablets, and educational software",
      icon: AcademicCapIcon,
      color: "from-purple-500 to-violet-500",
    },
    {
      title: "Library Books",
      description: "Reading materials and reference books",
      icon: AcademicCapIcon,
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#C5E3EA] via-[#ADE2ED] to-[#53AEC6]">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            Support children's education by donating school supplies, books, and learning materials. Help build a brighter future through knowledge.
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Choose from various educational donation categories to support learning
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {educationCategories.map((category, index) => (
              ...
              >
                <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 lg:p-8 border border-gray-100 group-hover:border-purple-200">
                  ...
                  <h3 className="text-xl lg:text-2xl font-bold text-gray-900 mb-3 group-hover:text-purple-600 transition-colors duration-300">
                    {category.title}
                  </h3>
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-100">
                    <button
                      onClick={() => navigate('/donation/education')}
                      className="text-purple-600 font-medium group-hover:text-purple-700 transition-colors duration-300 cursor-pointer"
                    >
                      Click to donate →
                    </button>
                  </div>
          ...
          >
            <div className="text-center mb-6">
              <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-2">
                Find Orphanages for Educational Donations
              </h2>
              <p className="text-gray-600">
                Search for orphanages in your area that need educational support
              </p>
            </div>
            ...
            <div className="p-6 lg:p-8 border-b border-gray-200">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                  ...
                  <p className="text-gray-600">
                    Discover orphanages and get directions to make your educational donations
                  </p>
                </div>
                <button
                  ref={relocateBtnRef}
