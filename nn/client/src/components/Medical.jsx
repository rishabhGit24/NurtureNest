...
const Medical = () => {
    ...
    return (
        ...
        >
            ...
            <h1 style={{ color: "white", fontSize: isMobile ? "2.5em" : "5em", marginBottom: isMobile ? "2em" : "", paddingTop: isMobile ? "" : "0.5em", paddingBottom: isMobile ? "20px" : "0.5em", marginTop: isMobile ? "-8px" : "-1em" }}>MEDICAL DONATIONS</h1>
            <div
                ...
                >
                    <section id="don1" style={{ marginLeft: isMobile ? "29em" : "-35em", marginTop: isMobile ? "-5em" : "120em", fontSize: isMobile ? "5.5px" : "7px", width: isMobile ? "72%" : "", height: isMobile ? "163em" : "" }}>
                        ...
                        <div className="all" style={{ height: isMobile ? "" : "", marginTop: isMobile ? "-10em" : "", paddingLeft: isMobile ? "3em" : "13em", paddingRight: isMobile ? "3em" : "13em" }}>
                            <ul>
                                <li>
                                    A survey conducted in 2021 found that a significant number of Indians are willing to donate medical supplies, but lack a convenient platform to do so. This NurtureNest web-app aims to bridge this gap by connecting medical donors with those in need.
                                </li><br /><hr id="sep" />
                                <li>
                                    Medical waste is a pressing issue in India, with many individuals lacking access to essential healthcare supplies. Many people are willing to donate medical items, but they often face challenges in finding the right channels to do so. Donating medical supplies can have a positive impact on both the environment and the community by reducing waste and providing essential items to those in need. There is a growing need for efficient medical donation systems to connect donors with individuals and organizations that can benefit from these contributions.
                                </li><br /><hr id="sep" />
                                <li>
                                    A survey conducted by various NGOs found that a large percentage of people believe that donating medical supplies is an important social responsibility. Hence, we'd like to enhance the accessibility between potential donors and organizations willing to accept valuable medical donations.
                                </li><br /><hr id="sep" />
                                <li>
                                    MEDICAL SUPPLIES CAN BE GIVEN AWAY IN FORM OF:<br /><br />
                                    1. Donations accepted for <strong>Cotton</strong>.<br />
                                    2. Donations accepted for <strong>Tapes</strong>.<br />
                                    3. Donations accepted for <strong>Scissors</strong>.<br />
                                    4. Donations accepted for <strong>Dettol</strong>.
                                </li>
                            </ul>
                        </div>
                    </section>
