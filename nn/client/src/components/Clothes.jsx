...
const Clothes = () => {
  ...
  const clothesCategories = [
    ...
    },
    {
      ...
      description: "Educational attire and uniforms",
      icon: GiftIcon,
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#C5E3EA] via-[#ADE2ED] to-[#53AEC6]">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            Provide clothing and footwear to children in orphanages. Help them stay warm, comfortable, and confident.
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Choose from various clothing donation categories to make the most meaningful impact
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {clothesCategories.map((category, index) => (
              ...
              >
                <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 lg:p-8 border border-gray-100 group-hover:border-pink-200">
          ...
          >
            <div className="text-center mb-6">
              <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-2">
                Find Orphanages for Clothing Donations
              </h2>
              <p className="text-gray-600">
                Search for orphanages in your area that need clothing donations
              </p>
            </div>
            ...
            <div className="p-6 lg:p-8 border-b border-gray-200">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                  ...
                  <p className="text-gray-600">
                    Discover orphanages and get directions to make your clothing donations
                  </p>
                </div>
                <button
                  ref={relocateBtnRef}
