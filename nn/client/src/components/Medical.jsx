...
const Medical = () => {
    ...
    return (
        ...
        >
            ...
            <h1 i style={{ color: "white", fontSize: isMobile ? "2.5em" : "5em", marginBottom: isMobile ? "2em" : "", paddingTop: isMobile ? "" : "0.5em", paddingBottom: isMobile ? "" : "0.5em" }}>Medical DONATIONS</h1>
            <section
                id="gps"
