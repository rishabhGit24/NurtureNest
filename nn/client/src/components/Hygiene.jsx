...
const Hygiene = () => {
    ...
    return (
        ...
        >
            ...
            <h1 style={{ color: "white", fontSize: isMobile ? "2.5em" : "5em", marginBottom: isMobile ? "2em" : "", paddingTop: isMobile ? "" : "0.5em", paddingBottom: isMobile ? "20px" : "0.5em", marginTop: isMobile ? "-8px" : "-1em" }}>HYGIENE DONATIONS</h1>
            <div
                ...
                >
                    <section id="don1" style={{ marginLeft: isMobile ? "29em" : "-35em", marginTop: isMobile ? "-5em" : "120em", fontSize: isMobile ? "5.5px" : "7px", width: isMobile ? "72%" : "", height: isMobile ? "163em" : "" }}>
                        ...
                        <div className="all" style={{ height: isMobile ? "" : "", marginTop: isMobile ? "-10em" : "", paddingLeft: isMobile ? "3em" : "13em", paddingRight: isMobile ? "3em" : "13em" }}>
                            <ul>
                                <li>
                                    A survey conducted in 2021 found that a significant number of Indians are willing to donate hygiene products, but lack a convenient platform to do so. This NurtureNest web-app aims to bridge this gap by connecting hygiene donors with those in need.
                                </li><br /><hr id="sep" />
                                <li>
                                    Hygiene is a critical aspect of health and well-being, yet many individuals lack access to essential hygiene products. Donating hygiene items can significantly improve the quality of life for those in need, helping to prevent illness and promote overall health. There is a growing need for efficient hygiene donation systems to connect donors with individuals and organizations that can benefit from these contributions.
                                </li><br /><hr id="sep" />
                                <li>
                                    A survey conducted by various NGOs found that a large percentage of people believe that donating hygiene products is an important social responsibility. Hence, we'd like to enhance the accessibility between potential donors and organizations willing to accept valuable hygiene donations.
                                </li><br /><hr id="sep" />
                                <li>
                                    HYGIENE PRODUCTS CAN BE GIVEN AWAY IN FORM OF:<br /><br />
                                    1. Donations accepted for <strong>Brushing Essentials</strong>.<br />
                                    2. Donations accepted for <strong>Soap</strong>.<br />
                                    3. Donations accepted for <strong>Skin Care</strong>.<br />
                                    4. Donations accepted for <strong>Other Amenities</strong>.
                                </li>
                            </ul>
                        </div>
                    </section>
